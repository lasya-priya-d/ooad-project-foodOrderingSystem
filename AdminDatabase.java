...
{	
	...
	public AdminDatabase(Admin n)
	{
		...
		try
		{
			...
			system.out.println("WOrks connection");
			Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3301/food_shop","root","Deepali26.");
			system.out.println("WOrks local connection");
	...
	public AdminDatabase(String query)
	{
		...
		{
			Class.forName("com.mysql.jdbc.Driver");
			Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/food_shop","root","root");
			Statement stmnt = con.createStatement();
