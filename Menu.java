...
{    
    ...
    JLabel burger1 = new JLabel("1.Cheese Burger(Rs 190/-)");
	JLabel pizza1 = new JLabel("1.Beef and Bacon (Rs 170/-)");
	JLabel burger2 = new JLabel("2.BBQ Cheese Burger(Rs 190/-) ");
	JLabel pizza2 = new JLabel("2.Cheesey Carlic Pizza (Rs 200/-)");
    JLabel burger3 = new JLabel("3.Twister (Rs 200/-)");
	JLabel pizza3 = new JLabel("3.Pepproni(Rs 220/-)");
	JLabel burger4 = new JLabel("4.Classic (Rs 220/-)");
	JLabel pizza4 = new JLabel("4.Creamy Prawn(Rs 240/-)");
	JLabel burger5 = new JLabel("5.The Regular (Rs 240/-)");
	JLabel pizza5 = new JLabel("5.Peri Peri Chicken(Rs 250/-)");
	JLabel burger6 = new JLabel("6.Beef & Bacon (Rs 250/-)");
	JLabel pizza6 = new JLabel("6.Grand Supremme(Rs 250/-)");
	JLabel burger7 = new JLabel("7.Counter Burger(Rs 250/-)");
	JLabel pizza7 = new JLabel("7.Garlic Prawn(Rs 260/-)");
	JLabel burger8 = new JLabel("8.Fish Burger(Rs 250/-)");
	JLabel pizza8 = new JLabel("8.BBQ Chicken & Bacon(Rs 280/-)");
	JLabel burger9 = new JLabel("9.Chicken Supremme(Rs 300/-)");
	JLabel pizza9 = new JLabel("9.Vaggie max(Rs 280/-)");
	JLabel burger10 = new JLabel("10.Whopper(Rs 320/-)");
	JLabel pizza10 = new JLabel("10.Bacon & Mushroom(Rs 300/-)");
	JLabel burger11 = new JLabel("11.Chicken Cheese Delight(Rs 340/-)");
	JLabel pizza11 = new JLabel("11.Smoked Chicken Pizza(Rs 300/-)");
	JLabel burger12 = new JLabel("12.Mushroom Caramel(Rs 320/-)");
	JLabel pizza12 = new JLabel("12.Sausage & Bacon(Rs 320/-)");
	JLabel burger13 = new JLabel("13.Tuna Burger(Rs 380/-)");
	JLabel pizza13 = new JLabel("13.Hot & Spicy Beef(Rs 340/-)");
	JLabel burger14 = new JLabel("14.Nutella & Nutty(Rs 400/-)");
	JLabel pizza14 = new JLabel("14.Hot & Twisted(Rs 340/-)");
	JLabel burger15 = new JLabel("15.Half Pounder(Rs 530/-)");
	JLabel pizza15 = new JLabel("15.Spicy Italian Sausage(Rs 340/-)");
	JLabel pastry = new JLabel("PASTRY");
	JLabel drinks = new JLabel("DRINKS");
    JLabel pastry1 = new JLabel("1.Black Forest (Rs 120 /-)");
	JLabel drinks1 = new JLabel("1.Water Bottle 500ml (Rs 15/-)");
	JLabel pastry2 = new JLabel("2.Vanilla Cream  Cake (Rs 120 /-)");
	JLabel drinks2 = new JLabel("2.Soft Drinks in Bottle(Rs 15/-)");
	JLabel pastry3 = new JLabel("3.Coffee Cream Cake  (Rs 130 /-)");
	JLabel drinks3 = new JLabel("3.Soft Drinks in can (Rs 35/-)");
	JLabel pastry4 = new JLabel("4.Strawberry Mousse Cake (Rs 140 /-)");
	JLabel drinks4 = new JLabel("4.Hot Chocolate(Rs 190/-)");
	JLabel pastry5 = new JLabel("5.Chocolate Mousse Cake (Rs 150 /-)");
	JLabel drinks5 = new JLabel("5.Lemonade (Rs 200/-)");
	JLabel pastry6 = new JLabel("6.Chocolate Fudge Cake(Rs 150 /-)");
	JLabel drinks6 = new JLabel("6.Smothie(Rs 220/-)");
	JLabel pastry7 = new JLabel("7.Red Velvet Cake(Rs 150 /-)");
	JLabel drinks7 = new JLabel("7.Flavored Shake(Rs 250/-)");
	JLabel pastry8 = new JLabel("8.Fruints & Nuts Cake(Rs 150 /-)");
	JLabel drinks8 = new JLabel("8.Blue Lagoon (Rs 250/-)");
	JLabel pastry9 = new JLabel("9.Cream Cheese Cake(Rs 160 /-)");
	JLabel drinks9 = new JLabel("9.Gummy Bear Drinks(Rs 300/-)");
	JLabel pastry10 = new JLabel("10.Chocolate Stream Cake(Rs 180 /-)");
	JLabel drinks10 = new JLabel();
	JLabel pastry11 = new JLabel("11.Blueberry Cheese Cake(Rs 180 /-)");
	JLabel drinks11 = new JLabel();
	JLabel pastry12 = new JLabel("12.Strawberry Cheese Cake(Rs 180 /-)");
	JLabel drinks12 = new JLabel();
	JLabel pastry13 = new JLabel("13.Cream Cheese Cake(Rs 160 /-)");
	JLabel drinks13 = new JLabel();
	JLabel pastry14 = new JLabel("14.Cookie & Cream(Rs 200 /-)");
	JLabel drinks14 = new JLabel();
	JLabel pastry15= new JLabel("15.Chocolate Rasberry Mousse Cake(Rs 220 /-)");
